...
class FourPlayerViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    {
        playerData[0].health = cellsArray[3].playerHealth
        playerData[1].health = cellsArray[2].playerHealth
        playerData[2].health = cellsArray[1].playerHealth
        playerData[3].health = cellsArray[0].playerHealth
    ...
    // estimated height per row - necessary
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if tableView == top_leftTableView {
            let cell = self.top_leftTableView.dequeueReusableCell(withIdentifier: "VerticalPlayerTableViewCell", for: indexPath) as! VerticalPlayerTableViewCell
            // player health
        ...
        if tableView == top_rightTableView {
            let cell = self.top_rightTableView.dequeueReusableCell(withIdentifier: "VerticalPlayerTableViewCell", for: indexPath) as! VerticalPlayerTableViewCell
            // player health
        ...
        if tableView == bottom_leftTableView {
            let cell = self.bottom_leftTableView.dequeueReusableCell(withIdentifier: "VerticalPlayerTableViewCell", for: indexPath) as! VerticalPlayerTableViewCell
            // player health
        ...
        // player 4 cell
        let cell = self.bottom_rightTableView.dequeueReusableCell(withIdentifier: "VerticalPlayerTableViewCell", for: indexPath) as! VerticalPlayerTableViewCell
        // player health
